namespace Nachonet.Common.Web.Oidc
{
    public interface IOidcClient
    {
        ...
        string GetAuthenticationUrl(string host, string state);
        Task<OidcCodeToken> GetTokenAsync(string host, string code, CancellationToken cancellationToken = default);
